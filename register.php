...
<head>
    ...
    <title>CSS PulseConnect — Register</title>
...
<body class="min-h-screen bg-zinc-950 text-zinc-100 auth-login-bg">
    ...
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2 relative z-10">
            ...
            <div class="max-w-md w-full">
                ...
                <div class="text-center mt-6">
                    ...
                    <p class="text-zinc-400 mt-4 text-sm leading-relaxed">
                        Students can register for events and get tickets. Teachers and Admin manage events, scanning, and analytics.
                    </p>
                </div>
                <div class="mt-8 rounded-2xl border border-zinc-800 bg-zinc-900/20 p-5 text-sm text-zinc-300 text-center">
        ...
        <?php if ($success): ?>
            <div class="mb-4 rounded-xl border border-emerald-900/50 bg-emerald-950/30 px-4 py-3 text-sm text-emerald-200">
                <?= htmlspecialchars($success) ?>
            </div>
            <a href="login.php" class="inline-flex items-center justify-center w-full rounded-xl bg-zinc-100 text-zinc-900 px-4 py-3 font-medium hover:bg-zinc-200 transition">
                Go to login
            </a>
        <?php else: ?>
            <form method="POST" class="rounded-2xl border border-zinc-800 bg-zinc-900/30 p-6">
                ...
                <label class="block text-xs text-zinc-400 mb-1" for="middle_name">Middle Name <span class="text-zinc-500">(optional)</span></label>
                <input
                    id="middle_name"
                    name="middle_name"
                    type="text"
                ...
                <label class="block text-xs text-zinc-400 mb-1" for="suffix">Suffix <span class="text-zinc-500">(optional)</span></label>
                <input
                    id="suffix"
                    name="suffix"
                    type="text"
